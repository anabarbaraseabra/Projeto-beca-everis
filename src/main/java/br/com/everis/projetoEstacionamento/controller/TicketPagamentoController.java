...
public class TicketPagamentoController {
	...
	@PostMapping("/entrada")
	public ResponseEntity<TicketEntradaDto> gerarTicketEntrada(@RequestBody TicketEntradaForm form) {
		return ResponseEntity.ok(ticketPagamentoServiceImpl.gerarTicketEntrada(form)) ;
	}
